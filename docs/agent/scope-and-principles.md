...
> **Canonical source for agent behavior rules in Recro AI.**

## What This Repo Is

Recro AI is an AI-powered application that helps users tailor resumes to job descriptions. It consists of:
