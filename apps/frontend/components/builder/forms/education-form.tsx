            ...
            <div className="space-y-8">
              {data.map((item) => (
                <DraggableListItem key={item.id} id={item.id}>
                  <div className="p-6 rounded-2xl border border-white/5 bg-zinc-900/30 backdrop-blur-sm relative group">
                    <Button
                      variant="ghost"
                      size="icon"
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        className="min-h-[60px] text-zinc-200 placeholder:text-zinc-600 text-sm rounded-xl border-white/10 bg-zinc-950 focus-visible:ring-emerald-500"
